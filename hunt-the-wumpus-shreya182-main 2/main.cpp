 ...
 * Description: Hunt the Wumpus game set inside a cave of the Wumpus, a monster. 
 * Guide the adventurer to win the game by escaping with the gold or killing the Wumpus.
 */
#include <iostream>
#include <cstdlib>
#include <ctime>
